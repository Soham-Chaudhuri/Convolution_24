                ...
                <div className="timeline_content1">
                  <div className="flex flex-col ">
                    ...
                    <p className="timeline_para">
                      - the participants will have to submit an abstract about
                      the idea they have chosen.
                      <br />
                    </p>
                  </div>
                </div>
              ...
              <div className="timeline_card">
                ...
                <div className="timeline_content1">
                  <div>
                    ...
                    <p className="timeline_para">
                      - participants will have to pitch their ideas infront of
                      the panel of judges
                      <br />
                    </p>
                  </div>
              ...
              <div className="timeline_card">
                ...
                <div className="timeline_content1">
                  <div>
                    ...
                    <p className="timeline_para">
                      - top 10 teams will have to present their prototypes
                      before the judges
                      <br />
                    </p>
                  </div>
              ...
              <div className="timeline_card">
                ...
                <div className="timeline_content1">
                  <div>
                    ...
                    <p className="timeline_para">
                      - top 3 teams from the 2nd round will be awarded with
                      exciting prizes.
                      <br />
                    </p>
                  </div>
