        ...
        <div className="Re_sp_about_layer_bg">
          ...
          <div className="Re_sp_about flex text-center flex-col align-center justify-center gap-6 py-10 px-6">
            ...
            <span className="Re_sp_para text-justify">
              ...
              &bull;Upon event registration, participants will receive the
              problem statements via their email.
              <br />
              <div className="h-[15px]"></div>
              &bull;<strong>Preliminary round:</strong> Teams will be
              shortlisted based on their idea which they have to pitch in front
              of the judges via online mode.
              <br />
