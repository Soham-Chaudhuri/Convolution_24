              ...
              <div className="timeline_card">
                ...
                <div className="timeline_content1">
                  <div>
                    ...
                    <p className="timeline_para">
                      - Deadline for selected finalists to confirm their
                      presence
                      <br />
                    </p>
                  </div>
              ...
              <div className="timeline_card">
                ...
                <div className="timeline_content1">
                  <div>
                    ...
                    <p className="timeline_para">
                      - The final list of selected finalists will be published
                      on the announcement blog on Codeforces, and the finalists
                      shall be sent a final email
                      <br />
                    </p>
                  </div>
                </div>
