        ...
        <div className="Re_in_about_layer_bg">
          ...
          <div className="Re_in_about flex text-center flex-col align-center justify-center gap-6 py-10 px-6">
            ...
            <span className="Re_in_para text-justify">
              ...
              <br />
              &emsp;a)1st round: On campus qualifying round. 10 teams will be
              shortlisted.
              <br />
              &emsp;b)2nd round: On campus final round. Top 3 teams will be
              rewarded.
              <br />
              ...
              <br />
              <div className="h-[15px]"></div>
              &bull;Cross department/college teams allowed. Cross year teams are
              also allowed.
              <br />
              <div className="h-[15px]"></div>
