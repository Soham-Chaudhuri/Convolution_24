  ...
  return (
    ...
    <div className="hero_bg p-4">
      <div className="m-4 hero_heading_1_div flex flex-wrap flex-col">
        <span className='hero_heading_1 text-shadow-md'>JUEE STUDENTS' FORUM</span>
        <span className='hero_heading_2 text-shadow-md'>CONVOLUTION 9.0</span>
        <span className="hero_heading_3">The Ninth Edition of Annual Technical Meet</span>
